...
/*package*/ abstract class Funnel {
    ...
    /*package*/ Funnel(PoliticlApp app, String schemaName, int revision) {
        this(app, schemaName, revision, SAMPLE_LOG_ALL);
    }

    /*package*/ Funnel(PoliticlApp app, String schemaName, int revision, @Nullable Site site) {
        this(app, schemaName, revision, SAMPLE_LOG_ALL, site);
    }

    /*package*/ Funnel(PoliticlApp app, String schemaName, int revision, int sampleRate) {
        this(app, schemaName, revision, sampleRate, null);
    }

    /*package*/ Funnel(PoliticlApp app, String schemaName, int revision, int sampleRate, @Nullable Site site) {
        this.app = app;
